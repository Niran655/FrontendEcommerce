...
mutation UpdatePurchaseOrderStatus($updatePurchaseOrderStatusId: ID!, $status: POStatus!) {
  updatePurchaseOrderStatus(id: $updatePurchaseOrderStatusId, status: $status) {
    isSuccess
    message {
      messageEn
      messageKh
